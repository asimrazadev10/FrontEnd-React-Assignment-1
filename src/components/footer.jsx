      ...
      <footer className="bg-black border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 place-items-center pb-10 mb-10 border-b border-white/10">
            {["Stripe","Figma","Notion","Canva","Slack","GitHub"].map((brand) => (
              <span
                key={brand}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-white/5 hover:bg-purple-600 border border-white/10 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200 hover:scale-105"
                >
